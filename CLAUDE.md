...
* **Prochaine session** : Phase 2 (event study — rendement forward, MAE/MFE, stabilité, décroissance au décalage, règle naïve de contrôle, mode multi-instruments par défaut), avec ses critères d'acceptation vérifiés avant toute autre phase.
