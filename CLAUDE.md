...
* **Prochaine session** : Phase 7 — module papiers, ou Phase 8 — interface web (le squelette peut démarrer dès maintenant, voir §5), selon la priorité choisie par l'utilisateur.
