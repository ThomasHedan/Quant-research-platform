...
* **Prochaine session** : le complément de Phase 4 (walk-forward, PBO/CSCV, sensibilité à la date de départ, coûts ×2) ou la Phase 6 (portefeuille et combinaison), selon la priorité choisie par l'utilisateur — voir §5 « Ordre de travail recommandé ».
