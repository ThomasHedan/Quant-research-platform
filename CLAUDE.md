...
* **Prochaine session** : Phase 3 — moteur de backtest complet (peut attendre, voir §5), Phase 7 — module papiers, ou Phase 8 — interface web (le squelette peut démarrer dès la fin de la Phase 5, voir §5), selon la priorité choisie par l'utilisateur.
