...
* **Prochaine session** : Phase 4 partielle (bootstrap par blocs, test de permutation, DSR alimenté par le registre — voir §5 « Ordre de travail recommandé » : Phases 0 → 2 → 4 (partiel) → 5 avant toute autre chose), avec ses critères d'acceptation vérifiés avant toute autre phase.
