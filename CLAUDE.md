...
* **Prochaine session** : Phase 6 — portefeuille et combinaison, ou Phase 3 — moteur de backtest complet (peut attendre, voir §5), selon la priorité choisie par l'utilisateur.
